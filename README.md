...
About us:
- IIT Bombay B.Tech. and Dual Degree (B.Tech. + M.Tech.) graduates
- Master’s from Imperial College London and PhD from EPFL, Switzerland
- Currently working in the UK and Switzerland
- IIT Bombay Placement offers at Schlumberger and Dr Reddy’s Laboratories

Having gone through competitive campus placements, international job applications and university applications ourselves, we understand how confusing and stressful the SoP and resume-writing process can be, and we are here to help!
...
Resume + SoP review and feedback:
- Early-bird price: ₹ 549
- Regular price: ₹ 749

Register before 15th March to claim the early-bird price!
